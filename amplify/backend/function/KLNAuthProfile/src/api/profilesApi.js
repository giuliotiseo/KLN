...
async function listProfiles(companyId) {
  let results = [];
  console.log("Effettuo la ricerca su companyId", companyId);
...
async function getProfile(profileId) {
  ...
  console.log("getProfile function", profileId);
  ...
  console.log("profileQueryParams", profileId);
