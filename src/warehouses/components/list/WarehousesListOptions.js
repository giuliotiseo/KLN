...
import { changeWarehousesListLimit, changeWarehousesListSearchable, DEFAULT_WAREHOUSES_LIMIT } from '../../slices/warehousesListSlice';

function WarehousesListOptions({
  inputSearchable = "",
  pagination,
      ...
      <div className='flex items-center flex-1'>
        <div className="flex flex-1">
          <InputText
            ...
            onPressEnter={() => dispatch(changeWarehousesListSearchable(searchable))}
          />

          <Button
            icon={<FiSearch />}
            onClick={() => dispatch(changeWarehousesListSearchable(searchable))}
        ...
        <LimitSelector
          limit={limit}
          className="mr-2"
          updateLimit={(value) => dispatch(changeWarehousesListLimit(value))}
        />
      </div>
...
export default WarehousesListOptions;
