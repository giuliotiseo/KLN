...
// import CustomerSearchContent from "../../../customers/components/form/CustomerSearchContent";
// import CustomerCompanyPicker from "../../../customers/components/form/CustomerCompanyPicker";
// import Button from "../../../globals/components/buttons_v2/Button";
// import SafeCol from "../../../globals/components/layout/SafeCol";
// import InputText from "../../../globals/components/dataEntry_v2/InputText";
...
// Main component -----------------------------------------------------------------------------------------------------------------------------
export default function ExternalSearchCompany({
  // companyFound,
  // setCompanyFound
}) {
  ...
  return (
    <SafeCol id="ExternalSearchCompany">
      <p>Inizia lo sviluppo da qui</p>
